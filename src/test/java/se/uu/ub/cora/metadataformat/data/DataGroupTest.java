...
public class DataGroupTest {
	...
	public void testEquals() {
		DataGroup dataGroup1 = DataGroup.withNameInData("nameInData");
		DataGroup dataGroup2 = DataGroup.withNameInData("nameInData");
		assertTrue(dataGroup1.equals(dataGroup2));
	}

	@Test
	public void testEqualsNull() {
		DataGroup dataGroup1 = DataGroup.withNameInData("nameInData");
		assertFalse(dataGroup1.equals(null));
	}

	@Test
	public void testEqualsNotSameObj() {
		DataGroup dataGroup1 = DataGroup.withNameInData("nameInData");
		assertFalse(dataGroup1.equals(""));
	}

	@Test
	public void testEqualsNotNameInData() {
		DataGroup dataGroup1 = DataGroup.withNameInData("nameInData");
		DataGroup dataGroup2 = DataGroup.withNameInData("NOTnameInData");
		assertFalse(dataGroup1.equals(dataGroup2));
	}

	@Test
	public void testEqualsNullThisNameInData() {
		DataGroup dataGroup1 = DataGroup.withNameInData(null);
		DataGroup dataGroup2 = DataGroup.withNameInData("nameInData");
		assertFalse(dataGroup1.equals(dataGroup2));
	}

	@Test
	public void testEqualsNullNameInData() {
		DataGroup dataGroup1 = DataGroup.withNameInData("nameInData");
		DataGroup dataGroup2 = DataGroup.withNameInData(null);
		assertFalse(dataGroup1.equals(dataGroup2));
	}

	@Test
	public void testEqualsNullBothNameInData() {
		DataGroup dataGroup1 = DataGroup.withNameInData(null);
		DataGroup dataGroup2 = DataGroup.withNameInData(null);
		assertFalse(dataGroup1.equals(dataGroup2));
	}

...
class DataTextVariableDecorator implements DataChildDecorator {

	private TextVariable textVariable;
	private String dataValue;

	public DataTextVariableDecorator(TextVariable textVariable) {
		this.textVariable = textVariable;
	}

	@Override
	public void decorateData(DataChild dataChild) {
		textVariable.getTextId();
		textHolder.getText(textid);
		DataAtomic dataAtomic = (DataAtomic) dataChild;
		dataChild.addAttributeByIdWithValue("", dataValue);
		// DataAtomic dataAtomic = (DataAtomic) dataChild;

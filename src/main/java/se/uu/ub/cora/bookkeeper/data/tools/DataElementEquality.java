...
public class DataElementEquality {
    ...
    private static boolean theyHaveEqualDataElementAndEqualValues(DataAtomic left, DataAtomic right) {
    ...
    private static boolean theyHaveEqualDataElements(DataElement left, DataElement right) {
        return haveEqualNames(left, right) &&
                theyHaveEqualRepeatIds(left, right) &&
    ...
    private static boolean neitherIsEmptyAndTheyHaveIdenticalAttributes(Map<String, String> left, Map<String, String> right) {
    ...
    private static boolean theyHaveIdenticalAttributes(Map<String, String> left, Map<String, String> right) {
    ...
    private static boolean theyHaveEqualAttributeCollectionsOfSameNonZeroSize(Map<String, String> left, Map<String, String> right) {
    ...
    private static List<Map.Entry<String, String>> getCollectionAsSortedList(Collection<Map.Entry<String, String>> collection) {
    ...
    private static boolean theyHaveEqualDataElementAndEqualChildren(DataGroup left, DataGroup right) {
        return theyHaveEqualDataElements(left, right) &&
                theyHaveEqualChildren(left, right);
    }
    ...
    private static boolean neitherIsEmptyAndBothHaveIdenticalChildren(List<DataElement> left, List<DataElement> right) {
    ...
    private static boolean bothAreSameSizeAndHaveIdenticalChildren(List<DataElement> left, List<DataElement> right) {
    ...
    private static boolean haveIdenticalChildren(List<DataElement> left, List<DataElement> right) {
        ...
        return left.stream().allMatch(leftChild -> hasNextChildAndTheyAreEqual(rightChildIterator, leftChild));
    }

    private static boolean hasNextChildAndTheyAreEqual(Iterator<DataElement> iterator, DataElement child) {
        return iterator.hasNext() && isEqual(iterator.next(), child);
    }

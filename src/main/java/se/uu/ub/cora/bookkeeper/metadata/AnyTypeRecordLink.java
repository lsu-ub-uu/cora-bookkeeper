...
public class AnyTypeRecordLink extends MetadataElementAbstract {

	private final List<String> attributeReferences = new ArrayList<>();

	public AnyTypeRecordLink(String id, String nameInData, String textId, String defTextId) {
		super(id, nameInData, textId, defTextId);
	}

	public static AnyTypeRecordLink withIdAndNameInDataAndTextIdAndDefTextId(String id,
			String nameInData, String textId, String defTextId) {
		return new AnyTypeRecordLink(id, nameInData, textId, defTextId);
	}
